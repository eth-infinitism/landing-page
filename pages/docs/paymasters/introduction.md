...
* To preserve privacy, a user can interact with assets in their account (for example, claimed tokens), without having to dox themselves by sending ETH from another KYCed wallet or centralized exchange just to pay for gas fees.
