...
A good reference point to start with is our basic implementation of a bundler. This bundler focuses on being compliant, not on being fast.
...
To build this bundler on your machine, please follow the instructions in the [repository README](https://github.com/eth-infinitism/bundler#readme).